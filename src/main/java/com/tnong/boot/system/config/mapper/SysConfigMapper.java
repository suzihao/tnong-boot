...
public interface SysConfigMapper {
    ...
    List<SysConfig> selectPageList(@Param("query") SysConfigQueryDTO query, @Param("tenantId") Long tenantId);
    Long selectCount(@Param("query") SysConfigQueryDTO query, @Param("tenantId") Long tenantId);
